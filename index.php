...
<head>
    ...
    <link rel="shortcut icon" href="depan/favicon.ico">
    ...
    <!-- Flexslider  -->
    <link rel="stylesheet" href="depan/css/flexslider.css">
    <!-- Flaticons  -->
    <link rel="stylesheet" href="depan/fonts/flaticon/font/flaticon.css">
    <!-- Owl Carousel -->
    ...
    <!-- Modernizr JS -->
    <script src="depan/js/modernizr-2.6.2.min.js"></script>
    <!-- FOR IE9 below -->
    <!--[if lt IE 9]>
...
<body>
                                ...
                                <div class="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                    <div class="col-md-12">
                                        <div class="about-desc">
                                            <span class="heading-meta">Tentang Kami</span>
    ...
    <!-- Flexslider -->
    <script src="depan/js/jquery.flexslider-min.js"></script>
    <!-- Owl carousel -->
    <script src="depan/js/owl.carousel.min.js"></script>
    <!-- Counters -->
    <script src="depan/js/jquery.countTo.js"></script>
